...
class Results {
  ...
  Results.fromJson(Map<String, dynamic> json) {
    ...
    comics =
        json['comics'] != null ? CommonData.fromJson(json['comics']) : null;
    series =
        json['series'] != null ? CommonData.fromJson(json['series']) : null;
    stories =
        json['stories'] != null ? CommonData.fromJson(json['stories']) : null;
    events =
        json['events'] != null ? CommonData.fromJson(json['events']) : null;
    if (json['urls'] != null) {
      urls = <Urls>[];
      json['urls'].forEach((v) {
...
class CommonData {
  ...
  CommonData({this.available, this.collectionURI, this.items, this.returned});
